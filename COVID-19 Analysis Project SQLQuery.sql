--COVID-19 Analysis Project
  --1. Introduction
    ...
    --causing unprecedented impacts on the health and economy of different countries and regions.
    --This project aims to analyze the data and provide insights related to COVID-19 testing, 
    --vaccination, and mortality across various locations and periods.
  ...
  --2. Data Source
	...
	--and vaccination activities and some demographic and socio-economic indicators for each location and date.
  ...
  --3. Data Overview
	...
	SELECT *
	FROM CovidDeaths;
	--The datasets contain data updated until when I downloaded them. The numbers in the "total" columns
  ...
  --5. Data Analysis
	...
	ORDER BY total_deaths DESC;
	ORDER BY death_rate DESC;
	--As of the latest date in the dataset, the United States has the highest number of cases, with about 103 million people affected.
	--The countries rating second and third are China and India, with about 99 million and 45 million respectively.
	--The United States still ranks number one in number of deaths, about 1 million people.
	--Brazil and India rated second and third, 70 thousand and 53 thousand respectively.
	--Yemen has the highest death rate of about 18%, more than doubling the number of the second country, which is Sudan.
	
	--How many countries have above-average death rates?
	WITH cte AS (
		SELECT location, SUM(new_cases) AS total_cases, SUM(new_deaths) AS total_deaths, SUM(new_deaths)/SUM(new_cases)*100 AS death_rate
		FROM CovidDeath
		WHERE total_cases IS NOT NULL AND total_deaths IS NOT NULL
	...
	--It can be used as an indicator of the impact of COVID-19 on mortality. 
	...
	--while the number of deaths that occur in the other three continents may rise suddenly during a certain period.
	...
	--How many countries have above-average vaccination rates?
	...
	--Until the latest date in the dataset, almost half of the countries have above-average vaccination rates.
	...
	--total cases vs. population for each country, which shows the percentage of the population got COVID-19
	WITH cte_cases AS (
	...
	--Which countries have more than 50% of their population fully vaccinated, and how much of their population is living in extreme poverty?
	...
	--It seems poverty is not directly related to vaccination.
	...
	--whereas the lowest country has only 0.1% of women and 15% of men smoking. The differences are very big.
	-It seems smoking has a great impact on dying from COVID-19.

	--Finally, I want to measure the effectiveness of vaccinations and boosters.
	--What are the top 10 countries with the highest ratio of people fully vaccinated to people who tested positive for COVID-19?
